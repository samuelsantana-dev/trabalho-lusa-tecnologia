        ...
        <div class="modal fade show" v-if="notaShowCadastro" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-xl">
                <div class="modal-content bg-dark">
                    ...
                    <div class="modal-body d-flex justify-content-center align-items-center">
                        <div id="div-nota-modal">
                            <div>
                                ...
                                <div>
                                    <form id="notaForm">
                                      <h5 @click="contatosListarInput('nota')">Clique aqui para mostrar bate-papo</h5>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="opcao-notas" rows="3"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="opcao-notas-name">Data e hora</label>
                                        <textarea class="form-control" id="opcao-notas-name" rows="3"></textarea>
                                    </div>
                    ...
                    <button type="button" class="btn btn-primary" @click="agendarNota">Salvar Nota</button>
                    </div>
                </div>
            </div>
        </div>
