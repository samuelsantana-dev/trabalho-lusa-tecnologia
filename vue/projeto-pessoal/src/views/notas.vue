...
.select-items div {
    padding: 10px;
    cursor: pointer;
    border-bottom: 1px solid #ddd; /* Borda entre as opções */
}
...
.select-hide {
    display: none; /* Esconde as opções */
}
...
<div class="form-container">
        <div class="form-group">
            ...
            <div class="tipo-container">
                <button class="tipo-button active">Nota do Grupo</button>
                <button class="tipo-button">Nota Individual</button>
            </div>
        </div>
        <div class="form-group">
